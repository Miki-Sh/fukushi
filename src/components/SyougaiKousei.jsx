...
const SyougaiKousei = (props) => {
  ...
  const list = [
    ...
    {
      'q': '初診日から1年6ヶ月の日、または、これ以上治療しても効果が期待できない状態になった日の時点で、1級（誰かの介助がないと、日常生活のほとんどのことができない）か2級（必ずしも他人の助けを借りる必要はなくても、日常生活は極めて困難で、働いて収入を得ることができない）、3級（日常生活にはほとんど支障はないが、労働については制限がある）の障害の状態ですか？',
      'yes': 0, 
      'no': 9,
    },
    {
