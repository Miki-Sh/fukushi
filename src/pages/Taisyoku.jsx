    ...
    <div className='text-red-950 text-lg'>
      ...
      <div className='my-12 flex flex-wrap items-center justify-center'>
        <Frame color='border-emerald-200' contents={ <>
          <h1 className='py-8 text-center text-indigo-900 text-3xl'>健康保険</h1>
          <p className='pb-6'>
          ...
          <Accordion
            ...
            text={
              <div>
                <p>　会社員の家族がいて、条件に当てはまる場合、家族の扶養に入ることであなたの保険料は支払わなくてよくなります。</p>
                <Link href='/Fuyou'><button className='mt-6 py-2 px-4 text-center shadow-md rounded-3xl font-semibold 
        ...
        <Frame color='border-emerald-200' contents={ <>
          <h1 className='py-8 text-center text-indigo-900 text-3xl'>年金</h1>
          <p className='pb-6'>
          ...
          <Accordion 
            ...
            title='国民年金に加入'
            text={
              <p>　会社員の人や扶養に入っている人以外は、国民年金に加入することになります。<br />
        ...
        <Frame color='border-emerald-200' contents={ <>
          <h1 className='py-8 text-center text-indigo-900 text-3xl'>雇用保険</h1>
          <p className='pb-4'>　会社で雇用保険に加入していて、条件に当てはまる人は、失業給付を受け取ることができます！</p>
          <p>もらえる金額は</p>
          ...
          <p>　もらっていたお給料が少ない人ほどたくさんもらえます。<br />「失業給付　計算サイト」でネット検索すると目安の金額がわかります！</p>
        ...
        <Frame color='border-emerald-200' contents={ <>
          <h1 className='py-8 text-center text-indigo-900 text-3xl'>住民税</h1>
          <p className='pb-6'>
