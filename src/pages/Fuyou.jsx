  ...
  return (
    <>
      <div className="my-12 mx-12 text-red-950 text-xl">
        <h1 className="pb-8 text-center text-indigo-900 text-3xl">扶養（ふよう）って何？</h1>
      ...
      <div className="my-12 flex flex-wrap justify-center items-center">
        <div className='inline-block lg:w-2/5 m-8 p-8 text-center rounded-3xl border-4 border-teal-500'>
